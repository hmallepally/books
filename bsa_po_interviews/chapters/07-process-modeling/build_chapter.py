...
def generate_chapter():
    ...
    output.append("""# Business Process Modeling & Design
...
""")
    ...
    # 2. BPMN Deep Dive and 15 Q&A Scenarios
    output.append("""
...
""")
    ...
    # 3. Process Mining and Optimization Techniques
    output.append("""
---
...
""")
    ...
    # 5. Massive Interview Q&A Section (Expanding word count significantly)
    output.append("""
---
...
""")
    ...
    with open(r"c:\Users\hari\Documents\DBA\books\bsa_po_interviews\chapters\07-process-modeling\base.md", 'w', encoding='utf-8') as f:
        for p in output:
            f.write(p)
