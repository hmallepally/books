#!/usr/bin/env python3
"""
Comprehensive Fix for All Layout Issues
"""
...
<body>
    ...
    output_file = 'Operational_Excellence_with_AI_CLEAN.html'
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(complete_html)
    
    print(f"✅ Clean HTML file created: {output_file}")
    return output_file

def generate_clean_pdf(html_file):
    ...
    async def generate_pdf():
        async with async_playwright() as p:
            ...
            output_pdf = 'Operational_Excellence_with_AI_CLEAN.pdf'
            await page.pdf(
                path=output_pdf,
                format='A4',
                margin={
            ...
            await browser.close()
            print(f"🎉 Clean PDF generated: {output_pdf}")
            print(f"📄 File size: {os.path.getsize(output_pdf) / 1024:.1f} KB")
    
    asyncio.run(generate_pdf())

if __name__ == "__main__":
    print("🚀 Creating clean HTML with proper structure...")
    
    # Create clean HTML
    html_file = create_clean_html()
    
    if html_file:
        # Generate clean PDF
        print("\n📚 Generating clean PDF...")
        generate_clean_pdf(html_file)
        ...
        print("\n📖 Please review the clean PDF!")
    else:
        print("❌ Failed to create clean HTML")
