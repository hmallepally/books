#!/usr/bin/env python3
"""
Create simple EPUB for KDP publishing
"""
...
def create_simple_epub():
    """Create a simple EPUB for KDP"""
    
    print("📚 Creating Simple EPUB for KDP Publishing")
    print("=" * 50)
...
<container version="1.0" xmlns="urn:oasis:names:tc:opendocument:xmlns:container">
    ...
    html_content = create_simple_html(md_content)
    
    # Write HTML file
    with open(os.path.join(oebps_dir, "content.html"), 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    # Copy images
    images_dir = os.path.join(oebps_dir, "images")
    if os.path.exists("final_versions/with_toc/images"):
        shutil.copytree("final_versions/with_toc/images", images_dir)
        print("📸 Images copied")
...
def create_simple_html(md_content):
    """Create simple HTML from markdown"""
