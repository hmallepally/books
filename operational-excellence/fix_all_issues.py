...
1. Fix TOC to fit on one page (add Chapter 16, reduce font size)
2. Move self-assessment from Chapter 2 to Chapter 1
3. Fix stories appearing on pages 229-230 instead of correct chapters
4. Generate final corrected PDF
"""
...
def fix_all_issues():
    ...
    print("🚀 Fixing all issues one by one...")
    
    # Read the HTML file
    with open('Operational_Excellence_with_AI_COMPLETE_FINAL.html', 'r', encoding='utf-8') as f:
        html_content = f.read()
    
    print("📝 Issue 1: Adding Chapter 16 to TOC with smaller font...")
    ...
    print("📝 Issue 2: Adding Sarah Chen story to Chapter 1 after overview...")
    ...
    print("📝 Issue 3: Adding Marcus Rodriguez story to Chapter 2 after overview...")
    ...
    print("📝 Issue 4: Adding self-assessment to Chapter 1 (not Chapter 2)...")
    ...
    # Add assessment to Chapter 1 before conclusion (make sure it's Chapter 1, not Chapter 2)
    html_content = re.sub(
    ...
    print("📝 Issue 5: Adding CSS for new elements and smaller TOC font...")
    
    # Add CSS for new elements and smaller TOC font
    new_css = '''
        .story-section {
            background: #f8f9fa;
        ...
        /* Smaller font for TOC to fit Chapter 16 on one page */
        .toc-list {
            font-size: 0.85em;
        }
...
def generate_final_pdf(html_file):
    ...
    async def generate_pdf():
        async with async_playwright() as p:
            ...
            output_pdf = 'Operational_Excellence_with_AI_FINAL_CORRECTED.pdf'
            await page.pdf(
                path=output_pdf,
                format='A4',
                margin={
            ...
            await browser.close()
            print(f"🎉 Final Corrected PDF generated: {output_pdf}")
...
if __name__ == "__main__":
    ...
    # Fix all issues
    html_file = fix_all_issues()
    
    if html_file:
        # Generate final corrected PDF
        print("\n📚 Generating final corrected PDF...")
        generate_final_pdf(html_file)
        
        print("\n✅ ALL ISSUES FIXED!")
        print("📋 This PDF now includes:")
        print("1. ✅ Chapter 16 added to TOC (with smaller font to fit on one page)")
        print("2. ✅ Sarah Chen story in Chapter 1 (after overview)")
        print("3. ✅ Marcus Rodriguez story in Chapter 2 (after overview)")
        print("4. ✅ Self-assessment quiz in Chapter 1 (not Chapter 2)")
        print("5. ✅ Stories in correct chapters (not on pages 229-230)")
        print("6. ✅ All content properly integrated")
        print("\n📖 The PDF should now be perfect with all issues resolved!")
    else:
